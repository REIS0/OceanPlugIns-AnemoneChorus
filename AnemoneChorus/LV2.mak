# -*- makefile -*-
JUCE_TARGET := AnemoneChorus
JUCE_TARGET_LV2 := $(JUCE_TARGET).so
JUCE_OUTDIR_LV2 := $(JUCE_OUTDIR)/$(JUCE_TARGET).lv2
JUCE_CFLAGS_LV2 := $(JUCE_CFLAGS_VST3)
JUCE_CPPFLAGS_LV2 := $(JUCE_CPPFLAGS_VST3)
JUCE_LDFLAGS_LV2 := $(JUCE_LDFLAGS_VST3)
...
$(JUCE_OUTDIR_LV2)/$(JUCE_TARGET_LV2) : check-pkg-config $(OBJECTS_LV2) $(RESOURCES) $(JUCE_OUTDIR)/$(JUCE_TARGET_SHARED_CODE)
	...
	python3 ../../generate-lv2-ttl.py $(JUCE_OUTDIR_LV2)/$(JUCE_TARGET_LV2)
